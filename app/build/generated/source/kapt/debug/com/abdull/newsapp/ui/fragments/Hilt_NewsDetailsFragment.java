...
public abstract class Hilt_NewsDetailsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_NewsDetailsFragment() {
    super();
  }

  Hilt_NewsDetailsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((NewsDetailsFragment_GeneratedInjector) this.generatedComponent()).injectNewsDetailsFragment(UnsafeCasts.<NewsDetailsFragment>unsafeCast(this));
    }
  }
